...
def arrow_viz(flo, img, save_path, imgname, positionX=50, positionY=10, interval=30):
    ...
    # flow_root = glob.glob(os.path.join(flo_path, '*.flo_flct'))
    ...
    u_norm = u / flowspeed  # / 2  # flowspeedmax * interval
    v_norm = v / flowspeed  # / 2  # flowspeedmax * interval
    ...
    # ax.quiver(coord_y, coord_x, u, v, norm(flow_color), cmap=cmaps.amwg_blueyellowred, width=0.01, scale=10,
    #           headwidth=3,
